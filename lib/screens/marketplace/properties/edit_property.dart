...
class EditProperty extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, OnPropertyEditedCallback>(
      converter: (store) {
      ...
      builder: (context, callback) {
        return EditPropertyWidget(callback);
      },
    );
  }
}
...
class EditPropertyWidget extends StatefulWidget {
  final OnPropertyEditedCallback callback;

  EditPropertyWidget(this.callback);

  @override
  State<StatefulWidget> createState() => EditPropertyWidgetState(callback);
}

class EditPropertyWidgetState extends State<EditPropertyWidget> {
  final _formKey = GlobalKey<FormState>();
  final OnPropertyEditedCallback callback;

  EditPropertyWidgetState(this.callback);
...
typedef OnPropertyEditedCallback = Function(String address);

...
//  const PropertyListWidget({Key: key, this.property}) : super(key: key);
...
//  @override
//  Widget build(BuildContext context) {
//    final PropertyArguments args = ModalRoute.of(context).settings.arguments;
//
//    Widget titleSection = Container(
//        padding: const EdgeInsets.all(32),
//        child: Row(children: [
